...
@implementation GCRecordEncoder


//GCRecordEncoder遍历构造器的
+ (GCRecordEncoder*)encoderForPath:(NSString*) path Height:(NSInteger) cy width:(NSInteger) cx channels: (int) ch samples:(Float64) rate {
    GCRecordEncoder* enc = [GCRecordEncoder alloc];
