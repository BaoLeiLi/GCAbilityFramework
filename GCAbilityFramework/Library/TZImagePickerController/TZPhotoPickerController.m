...
//    _numberLable.frame = _numberImageView.frame;
    _numberLable.frame = CGRectMake(self.view.tz_width - 56 - 56, 12, 50, 26);
    _numberLable.font = [UIFont systemFontOfSize:15];
    _numberLable.textColor = [UIColor whiteColor];
    _numberLable.textAlignment = NSTextAlignmentCenter;
    _numberLable.layer.cornerRadius = 3;
    _numberLable.layer.masksToBounds = YES;
    _numberLable.text = [NSString stringWithFormat:@"%zd/%ld",tzImagePickerVc.selectedModels.count,self.maxImagesCount];
    _numberLable.hidden = tzImagePickerVc.selectedModels.count <= 0;
    _numberLable.backgroundColor = [UIColor colorWithRed:31/255.0 green:185/255.0 blue:34/255.0 alpha:1];
...
//    _numberImageView.hidden = imagePickerVc.selectedModels.count <= 0;
    ...
    _numberLable.text = [NSString stringWithFormat:@"%zd/%ld",imagePickerVc.selectedModels.count,self.maxImagesCount];
